...
public class personaje : MonoBehaviour
{
    ...
    public bool estaEnPiso,ganaste;
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Z) || OVRInput.GetDown(OVRInput.Button.One))
        {
    ...
    public void muevePersonaje()
    {
        ...
        controlGiro = (Input.GetAxis("Giro"));
        ...
        gameObject.transform.Rotate(new Vector3(0,1,0),controlGiro*Time.deltaTime);
    }
